...
class Func(SQLiteNumericMixin, Expression):
    ...
    extra: dict[Any, Any]
    def __init__(
        self, *expressions: Any, output_field: Field | None = ..., **extra: Any
    ) -> None: ...
    def as_sql(
        self,
        compiler: SQLCompiler,
...
class RawSQL(Expression):
    ...
    sql: str
    def __init__(
        self, sql: str, params: Sequence[Any], output_field: Field | None = ...
    ) -> None: ...
...
class Col(Expression):
    ...
    def __init__(
        self, alias: str, target: Field, output_field: Field | None = ...
    ) -> None: ...
...
class Subquery(BaseExpression, Combinable):
    ...
    extra: dict[Any, Any]
    def __init__(
        self, queryset: Query | QuerySet, output_field: Field | None = ..., **extra: Any
    ) -> None: ...
...
class Window(SQLiteNumericMixin, Expression):
    ...
    def __init__(
        ...
        order_by: (
            Sequence[BaseExpression | F | str] | BaseExpression | F | str | None
        ) = ...,
