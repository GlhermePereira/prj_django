...
class SQLCompiler:
    ...
    ordering_parts: Any
    def __init__(
        self, query: Query, connection: BaseDatabaseWrapper, using: str | None
    ) -> None: ...
    col_count: int | None
    ...
    def get_select(self, with_col_aliases: bool = ...) -> tuple[
    ...
    def execute_sql(
        self,
        result_type: Literal["no results"] | None = ...,
        chunked_fetch: bool = ...,
        chunk_size: int = ...,
    ) -> None: ...
    @overload
