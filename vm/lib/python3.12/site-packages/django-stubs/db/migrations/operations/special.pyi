...
_SqlOperations: TypeAlias = (
    str | _ListOrTuple[str | tuple[str, dict[str, Any] | _ListOrTuple[Any] | None]]
)
...
class SeparateDatabaseAndState(Operation):
    ...
    def __init__(
        self,
        database_operations: Sequence[Operation] | None = ...,
...
class _CodeCallable(Protocol):
    def __call__(
        self, state_apps: StateApps, schema_editor: BaseDatabaseSchemaEditor, /
    ) -> None: ...
