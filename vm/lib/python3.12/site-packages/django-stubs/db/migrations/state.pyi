...
class ProjectState:
    ...
    def alter_model_options(
        ...
        model_name: str,
        options: dict[str, Any],
        option_keys: Iterable[str] | None = ...,
    ) -> None: ...
    def remove_model_options(
        self, app_label: str, model_name: str, option_name: str, value_to_remove: Any
    ) -> None: ...
    def alter_model_managers(
        self, app_label: str, model_name: str, managers: list[tuple[str, Manager]]
    ) -> None: ...
    def add_index(self, app_label: str, model_name: str, index: Any) -> None: ...
    def remove_index(
        self, app_label: str, model_name: str, index_name: str
    ) -> None: ...
    def rename_index(
        self, app_label: str, model_name: str, old_index_name: str, new_index_name: str
    ) -> None: ...
    def add_constraint(
        self, app_label: str, model_name: str, constraint: Any
    ) -> None: ...
    def remove_constraint(
        self, app_label: str, model_name: str, constraint_name: str
    ) -> None: ...
    def add_field(
        self,
        app_label: str,
    ...
    def rename_field(
        self, app_label: str, model_name: str, old_name: str, new_name: str
    ) -> None: ...
    ...
    def resolve_model_relations(
        self, model_key: tuple[str, str], concretes: Any | None = ...
    ) -> None: ...
