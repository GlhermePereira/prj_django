...
class BaseCache:
    ...
    def get(
        self, key: Any, default: Any | None = ..., version: int | None = ...
    ) -> Any: ...
    async def aget(
        self, key: Any, default: Any | None = ..., version: int | None = ...
    ) -> Any: ...
    ...
    def touch(
        self, key: Any, timeout: float | None = ..., version: int | None = ...
    ) -> bool: ...
    async def atouch(
        self, key: Any, timeout: float | None = ..., version: int | None = ...
    ) -> bool: ...
    ...
    def get_many(
        self, keys: Iterable[Any], version: int | None = ...
    ) -> dict[Any, Any]: ...
    async def aget_many(
        self, keys: Iterable[Any], version: int | None = ...
    ) -> dict[Any, Any]: ...
    ...
    async def aincr(
        self, key: Any, delta: int = ..., version: int | None = ...
    ) -> int: ...
