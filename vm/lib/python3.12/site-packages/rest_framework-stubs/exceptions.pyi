...
_ErrorFullDetails: TypeAlias = (
    _FullDetailDict | list[_ErrorFullDetails] | dict[str, _ErrorFullDetails]
)

def _get_error_details(
    data: _APIExceptionInput, default_code: str | None = ...
) -> _Detail: ...
...
class APIException(Exception):
    ...
    detail: _Detail
    def __init__(
        self, detail: _APIExceptionInput = ..., code: str | None = ...
    ) -> None: ...
...
class MethodNotAllowed(APIException):
    def __init__(
        self, method: str, detail: _APIExceptionInput = ..., code: str | None = ...
    ) -> None: ...
...
class UnsupportedMediaType(APIException):
    def __init__(
        self, media_type: str, detail: _APIExceptionInput = ..., code: str | None = ...
    ) -> None: ...
...
def server_error(
    request: HttpRequest | Request, *args: Any, **kwargs: Any
) -> JsonResponse: ...
def bad_request(
    request: HttpRequest | Request, exception: Exception, *args: Any, **kwargs: Any
) -> JsonResponse: ...
