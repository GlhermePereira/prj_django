...
def endpoint_ordering(
    endpoint: tuple[Incomplete, Incomplete, Incomplete]
) -> tuple[int]: ...
...
class EndpointEnumerator:
    ...
    def get_api_endpoints(
        self, patterns: Iterable[_AnyURL] | None = ..., prefix: str = ...
    ) -> list[_APIEndpoint]: ...
...
class BaseSchemaGenerator:
    ...
    def create_view(
        self, callback: Any, method: str, request: Request | None = ...
    ) -> Any: ...
    def coerce_path(self, path: str, method: str, view: APIView) -> str: ...
    def get_schema(
        self, request: Request | None = ..., public: bool = ...
    ) -> coreapi.Document | None: ...
