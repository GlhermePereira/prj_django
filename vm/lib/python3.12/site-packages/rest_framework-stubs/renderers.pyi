...
class JSONRenderer(BaseRenderer):
    ...
    def get_indent(
        self, accepted_media_type: str, renderer_context: Mapping[str, Any]
    ) -> int | None: ...
...
class HTMLFormRenderer(BaseRenderer):
    ...
    def render_field(
        self, field: Incomplete, parent_style: Mapping[str, Any]
    ) -> str: ...
...
class BrowsableAPIRenderer(BaseRenderer):
    ...
    def show_form_for_method(
        self, view: APIView, method: str, request: Request, obj: Any
    ) -> bool: ...
    def _get_serializer(
        self,
    ...
    def get_filter_form(
        self, data: Any, view: APIView, request: Request
    ) -> Any | None: ...
    def get_context(
        self,
        data: Any,
...
class AdminRenderer(BrowsableAPIRenderer):
    def get_result_url(
        self, result: Mapping[str, Any], view: APIView
    ) -> str | None: ...
...
class _BaseOpenAPIRenderer:
    ...
    def get_operation(
        self, link: Incomplete, name: Incomplete, tag: Incomplete
    ) -> dict[str, Any]: ...
