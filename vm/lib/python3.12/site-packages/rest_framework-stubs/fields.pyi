...
class ChoiceField(
    Field[str, str | int | tuple[str | int, str | int | tuple], str, Any]
):
...
class MultipleChoiceField(
    ...
    def __init__(
        ...
        *,
        ...
        initial: _DefaultInitial[
            set[StrOrPromise | int] | set[StrOrPromise] | set[int]
        ] = ...,
        source: str | None = None,
        label: StrOrPromise | None = None,
        help_text: StrOrPromise | None = None,
