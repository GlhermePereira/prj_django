...
class UniqueValidator:
    ...
    lookup: str
    def __init__(
        self, queryset: QuerySet, message: StrOrPromise | None = ..., lookup: str = ...
    ) -> None: ...
    def filter_queryset(
        self, value: Any, queryset: QuerySet[_T], field_name: str
    ) -> QuerySet[_T]: ...
    def exclude_current_instance(
        self, queryset: QuerySet[_T], instance: _T
    ) -> QuerySet[_T]: ...
...
class UniqueTogetherValidator:
    ...
    def enforce_required_fields(
        self, attrs: Container[str], serializer: BaseSerializer
    ) -> None: ...
    def filter_queryset(
        self,
    ...
    def __call__(
        self, attrs: MutableMapping[str, Any], serializer: BaseSerializer
    ) -> None: ...
