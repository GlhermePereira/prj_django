...
class ReturnDict(dict[_KT, _VT], Generic[_KT, _VT]):
    ...
    @overload
    def __init__(
        self: ReturnDict[str, _VT], *, serializer: BaseSerializer, **kwargs: _VT
    ) -> None: ...
    @overload
    def __init__(
        self, __map: SupportsKeysAndGetItem[_KT, _VT], *, serializer: BaseSerializer
    ) -> None: ...
    @overload
    def __init__(
    ...
    @overload
    def __init__(
        self, __iterable: Iterable[tuple[_KT, _VT]], *, serializer: BaseSerializer
    ) -> None: ...
    @overload
    def __init__(
        self: ReturnDict[str, _VT],
    ...
    @overload
    def __init__(
        self: ReturnDict[bytes, bytes],
        __iterable: Iterable[list[bytes]],
        *,
        serializer: BaseSerializer,
    ) -> None: ...
...
class ReturnList(list[_T], Generic[_T]):
    ...
    @overload
    def __init__(
        self, __iterable: Iterable[_T], *, serializer: BaseSerializer
    ) -> None: ...
...
class BoundField:
    ...
    def __init__(
        self, field: Field, value: Any, errors: list[ErrorDetail], prefix: str = ...
    ) -> None: ...
