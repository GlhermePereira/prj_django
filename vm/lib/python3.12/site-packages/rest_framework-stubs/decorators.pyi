...
def api_view(
    ...
    [Callable[Concatenate[Request, _P], _RESP]],
    AsView[Callable[Concatenate[HttpRequest, _P], _RESP]],
]: ...
def renderer_classes(
    renderer_classes: Sequence[BaseRenderer | type[BaseRenderer]],
) -> Callable[[_View], _View]: ...
def parser_classes(
    parser_classes: Sequence[BaseParser | type[BaseParser]],
) -> Callable[[_View], _View]: ...
def authentication_classes(
    authentication_classes: Sequence[BaseAuthentication | type[BaseAuthentication]],
) -> Callable[[_View], _View]: ...
def throttle_classes(
    throttle_classes: Sequence[BaseThrottle | type[BaseThrottle]],
) -> Callable[[_View], _View]: ...
def permission_classes(
    permission_classes: Sequence[_PermissionClass],
) -> Callable[[_View], _View]: ...
def schema(
    view_inspector: ViewInspector | type[ViewInspector] | None,
) -> Callable[[_View], _View]: ...
def action(
